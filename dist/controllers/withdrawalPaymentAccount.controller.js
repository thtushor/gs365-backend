...
exports.getAccountStats = exports.updateVerificationStatus = exports.setAccountAsPrimary = exports.deactivateWithdrawalPaymentAccount = exports.deleteWithdrawalPaymentAccount = exports.updateWithdrawalPaymentAccount = exports.getPrimaryWithdrawalPaymentAccount = exports.getWithdrawalPaymentAccountsByUserId = exports.getWithdrawalPaymentAccounts = exports.getWithdrawalPaymentAccountById = exports.createWithdrawalPaymentAccount = void 0;
const withdrawalPaymentAccount_model_1 = require("../models/withdrawalPaymentAccount.model");
const asyncHandler_1 = require("../utils/asyncHandler");
// Create a new withdrawal payment account
exports.createWithdrawalPaymentAccount = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        console.log("🔄 Creating withdrawal payment account...");
        const { userId, paymentGatewayId, accountNumber, holderName, provider, bankName, branchName, branchAddress, swiftCode, iban, routingNumber, walletAddress, network, accountHolderPhone, accountHolderEmail, country, state, city, address, postalCode, isPrimary = false, isVerified = false, isActive = true, verificationStatus = "pending", verificationNotes, minWithdrawalAmount, maxWithdrawalAmount, withdrawalFee, processingTime, additionalInfo, } = req.body;
        ...
        const result = await withdrawalPaymentAccount_model_1.WithdrawalPaymentAccountModel.create(accountData);
...
exports.getWithdrawalPaymentAccountById = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const result = await withdrawalPaymentAccount_model_1.WithdrawalPaymentAccountModel.getById(Number(id));
        if (!result) {
...
exports.getWithdrawalPaymentAccounts = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        console.log("🔄 Fetching withdrawal payment accounts...");
        const { userId, paymentGatewayId, provider, isActive, verificationStatus, country, isPrimary, limit = 50, offset = 0, sortBy = "createdAt", sortOrder = "desc", } = req.query;
        // Parse and validate parameters
        const filters = {
            userId: userId ? Number(userId) : undefined,
            paymentGatewayId: paymentGatewayId ? Number(paymentGatewayId) : undefined,
            provider: provider ? (Array.isArray(provider) ? provider : [provider]) : undefined,
            isActive: isActive !== undefined ? isActive === "true" : undefined,
            verificationStatus: verificationStatus ? (Array.isArray(verificationStatus) ? verificationStatus : [verificationStatus]) : undefined,
            country: country,
        ...
        const result = await withdrawalPaymentAccount_model_1.WithdrawalPaymentAccountModel.getWithFilters(filters);
...
exports.getWithdrawalPaymentAccountsByUserId = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        ...
        const result = await withdrawalPaymentAccount_model_1.WithdrawalPaymentAccountModel.getByUserId(Number(userId));
...
exports.getPrimaryWithdrawalPaymentAccount = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        const { userId } = req.params;
        if (!userId || isNaN(Number(userId))) {
            return res.status(400).json({
        ...
        const result = await withdrawalPaymentAccount_model_1.WithdrawalPaymentAccountModel.getPrimaryByUserId(Number(userId));
        if (!result) {
            return res.status(404).json({
                success: false,
...
exports.updateWithdrawalPaymentAccount = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        const { id } = req.params;
        if (!id || isNaN(Number(id))) {
            return res.status(400).json({
        ...
        const result = await withdrawalPaymentAccount_model_1.WithdrawalPaymentAccountModel.update(Number(id), updateData);
        if (!result) {
            return res.status(404).json({
                success: false,
                message: "Withdrawal payment account not found",
...
exports.deleteWithdrawalPaymentAccount = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        const { id } = req.params;
        if (!id || isNaN(Number(id))) {
            return res.status(400).json({
        ...
        const result = await withdrawalPaymentAccount_model_1.WithdrawalPaymentAccountModel.delete(Number(id));
        if (!result) {
            return res.status(404).json({
                success: false,
                message: "Withdrawal payment account not found",
...
exports.deactivateWithdrawalPaymentAccount = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        const { id } = req.params;
        if (!id || isNaN(Number(id))) {
            return res.status(400).json({
        ...
        const result = await withdrawalPaymentAccount_model_1.WithdrawalPaymentAccountModel.deactivate(Number(id));
        if (!result) {
            return res.status(404).json({
                success: false,
                message: "Withdrawal payment account not found",
...
exports.setAccountAsPrimary = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const result = await withdrawalPaymentAccount_model_1.WithdrawalPaymentAccountModel.setAsPrimary(Number(id), Number(userId));
        if (!result) {
            return res.status(404).json({
                success: false,
                message: "Withdrawal payment account not found",
...
exports.updateVerificationStatus = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const result = await withdrawalPaymentAccount_model_1.WithdrawalPaymentAccountModel.updateVerificationStatus(Number(id), status, notes);
        if (!result) {
            return res.status(404).json({
                success: false,
                message: "Withdrawal payment account not found",
...
exports.getAccountStats = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        const { userId } = req.query;
        console.log("🔄 Fetching withdrawal payment account statistics...");
        const result = await withdrawalPaymentAccount_model_1.WithdrawalPaymentAccountModel.getAccountStats(userId ? Number(userId) : undefined);
