...
exports.sendCustomEmail = exports.sendTransactionEmail = exports.sendPasswordResetEmail = exports.sendWelcomeEmail = exports.sendOTPEmail = exports.sendEmail = void 0;
 ...
 */
const sendPasswordResetEmail = async (email, resetLink, expiryMinutes = 30) => {
    return (0, exports.sendEmail)({
        to: email,
 ...
 */
const sendTransactionEmail = async (email, type, amount, status, transactionId) => {
    const statusColors = {
        pending: "#f59e0b",
        approved: "#10b981",
        rejected: "#ef4444",
 ...
 */
const sendCustomEmail = async (to, subject, html, from) => {
    return (0, exports.sendEmail)({ to, subject, html, from });
};
