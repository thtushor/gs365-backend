...
export class CommissionController {
  ...
  static createCommission = asyncHandler(
  ...
  static getCommissionById = asyncHandler(
    async (req: Request, res: Response) => {
      const { id } = req.params;
  ...
  // Get commission by ID
  static getTotalCommission = asyncHandler(
    async (req: Request, res: Response) => {
      ...
      const commission =
        await CommissionModel.getTotalCommissionWinLossByAffiliate(
  ...
  static getAllCommissions = asyncHandler(
    async (req: Request, res: Response) => {
  ...
  static getCommissionsByAdminUser = asyncHandler(
    async (req: Request, res: Response) => {
  ...
  static getCommissionsByPlayer = asyncHandler(
    async (req: Request, res: Response) => {
  ...
  static getCommissionsByBetResult = asyncHandler(
    async (req: Request, res: Response) => {
      const { betResultId } = req.params;
      const commissions = await CommissionModel.getCommissionsByBetResult(
        parseInt(betResultId)
      );
  ...
  static getCommissionsByStatus = asyncHandler(
    async (req: Request, res: Response) => {
      const { status } = req.params;
      const page = parseInt(req.query.page as string) || 1;
      const limit = parseInt(req.query.limit as string) || 10;

      const result = await CommissionModel.getCommissionsByStatus(
        status,
        page,
        limit
      );
  ...
  static updateCommission = asyncHandler(
    async (req: Request, res: Response) => {
      ...
      const updatedCommission = await CommissionModel.updateCommission(
        parseInt(id),
        updateData
      );
  ...
  // Delete commission
  static deleteCommission = asyncHandler(
    async (req: Request, res: Response) => {
      const { id } = req.params;
      const deletedCommission = await CommissionModel.deleteCommission(
        parseInt(id)
      );
  ...
  static getCommissionStats = asyncHandler(
    async (req: Request, res: Response) => {
  ...
  static getCommissionStatsByAdminUser = asyncHandler(
    async (req: Request, res: Response) => {
      const { adminUserId } = req.params;
      const stats = await CommissionModel.getCommissionStatsByAdminUser(
        parseInt(adminUserId)
      );
  ...
  // Approve commission
  static approveCommission = asyncHandler(
    async (req: Request, res: Response) => {
      const { id } = req.params;
      const updateData: CommissionUpdateData = {
        status: "approved",
  ...
  // Reject commission
  static rejectCommission = asyncHandler(
    async (req: Request, res: Response) => {
      const { id } = req.params;
      const updateData: CommissionUpdateData = {
        status: "rejected",
  ...
  static markCommissionAsPaid = asyncHandler(
    async (req: Request, res: Response) => {
      const { id } = req.params;
      const updateData: CommissionUpdateData = {
        status: "paid",
